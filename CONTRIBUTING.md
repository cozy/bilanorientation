# How to contribute to Bilanorientation?
...
- What is the version of the Bilanorientation app?
...
```
$ git clone github.com/crash/bilanorientation.git
$ cd bilanorientation
$ git remote add fork git://github.com/yourusername/bilanorientation.git
```
...
Go to https://github.com/yourusername/bilanorientation and select your branch. Click the 'Pull Request' button and fill out the form.
...
The Bilanorientation is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/crash/bilanorientation/issues/new
...
[localization]: https://github.com/crash/bilanorientation/blob/master/README.md#localization
